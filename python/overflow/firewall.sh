...
# http
$IPTABLES -A INPUT -p tcp -s 192.168.24.8 --dport 80 -j ACCEPT
$IPTABLES -A INPUT -p tcp  -s 192.168.24.19 --dport 80 -j ACCEPT
$IPTABLES -A INPUT -p tcp  -s 192.168.24.9 --dport 80 -j ACCEPT
$IPTABLES -A INPUT -p tcp -s 192.168.24.12 --dport 80 -j ACCEPT
$IPTABLES -A INPUT -p tcp  -s 192.168.24.21 --dport 80 -j ACCEPT
$IPTABLES -A INPUT -p tcp  -s 192.168.24.27 --dport 80 -j ACCEPT
$IPTABLES -A INPUT -p tcp  -s 192.168.24.25 --dport 80 -j ACCEPT
$IPTABLES -A INPUT -p tcp  -s 192.168.24.21 --dport 80 -j ACCEPT
$IPTABLES -A INPUT -p tcp  -s 192.168.24.17 --dport 80 -j ACCEPT
# pop3
...
$IPTABLES -A INPUT -p tcp -s 192.168.24.8 --dport 22 -j ACCEPT
$IPTABLES -A INPUT -p tcp  -s 192.168.24.19 --dport 22 -j ACCEPT
$IPTABLES -A INPUT -p tcp -s 192.168.24.9 --dport 22 -j ACCEPT
